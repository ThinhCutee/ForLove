...
$(document).ready(function () {
  ...
  let textTitle = "Gửi Thư Dễ Thương!";
  let charArrTitle = textTitle.split("");
  let text =
    "Mong rằng mùa Giáng sinh năm nay sẽ mang đến cho Thư thật nhiều niềm vui, hạnh phúc và nhiều khoảnh khắc ngọt ngào đáng nhớ.";
